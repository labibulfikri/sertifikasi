...
class M_aset extends CI_Model
{
    ...
    function make_query()
    {
        ...
        FROM
            m_aset_baru
            LEFT JOIN ( SELECT * FROM m_aset_det GROUP BY id_det_aset, id_aset ORDER BY status_map desc ) m_aset_det ON ( m_aset_det.id_aset = m_aset_baru.id_aset ) 
        ";
        // $select_column .= " ORDER BY status_map desc";
        ...
        // $this->db->order_by('status_map', 'asc');
...
//          exit();
    ...
    FROM
        `m_aset_baru`
        LEFT JOIN (SELECT * FROM m_aset_det GROUP BY id_det_aset, id_aset ORDER BY status_map desc ) m_aset_det ON (
    ...
    function peta_bidang2($id_aset)
    {
        ...
        $select_column = array(
            ...
            "m_aset_det.luas_pendaftaran",
            "m_aset_det.luas_permohonan",
            "m_aset_det.luas_peta",
    ...
    function upload_sertifikat($data)
    {

        $this->db->insert('upload_sertifikat', $data);
    ...
    { 
        ...
        $exe = $this->db->where('id_sertifikasi', $id);
        $exe = $this->db->update('upload_sertifikat', $data);
    ...
    function file_sertifikasi($id_aset)
    {

        $id_aset = $id_aset;

        $table = "upload_sertifikat";
        $select_column = array(
            "upload_sertifikat.id_aset_sertifikasi",
            "upload_sertifikat.id_sertifikasi",
            "upload_sertifikat.keterangan_sertifikasi", 
            "upload_sertifikat.nama_sertifikasi", 
            "upload_sertifikat.judul_sertifikasi", 
        );
        $this->db->select($select_column);
        $this->db->from($table);


        $this->db->join('m_aset_baru', 'm_aset_baru.id_aset = upload_sertifikat.id_aset_sertifikasi','left');
        $this->db->where('upload_sertifikat.id_aset_sertifikasi', $id_aset);
        $query = $this->db->get();
    ...
    function hapus_data_sertifikasi($id)
    {
        $id = $id;
        $this->db->where('id_sertifikasi', $id);
        $this->db->delete('upload_sertifikat');
    }
    ...
    function datakelurahan2($id, $search)
    {
        $table = "villages";
        $select_column = array(
            "villages.id",
    ...
    function make_query_lap($searcMap)
    {
        ...
        FROM
            `m_aset_baru`";
        if ($searcMap == "3") {
            $select_column .= "  JOIN (SELECT * FROM m_aset_det GROUP BY id_aset HAVING status_map = 3 ORDER BY status_map asc ) m_aset_det ON (
                m_aset_det.id_aset = m_aset_baru.id_aset) ";
        } else if ($searcMap == "2") {

            $select_column .= "  JOIN (SELECT * FROM m_aset_det GROUP BY id_aset HAVING status_map = 2 ORDER BY status_map asc ) m_aset_det ON (
                m_aset_det.id_aset = m_aset_baru.id_aset) ";
        } else if ($searcMap == "1") {

            $select_column .= "  JOIN (SELECT * FROM m_aset_det GROUP BY id_aset HAVING status_map = 1 ORDER BY status_map asc ) m_aset_det ON (
                m_aset_det.id_aset = m_aset_baru.id_aset) ";
        } else {

            $select_column .= " LEFT JOIN (SELECT * FROM m_aset_det GROUP BY id_aset ORDER BY status_map asc ) m_aset_det ON (
                m_aset_det.id_aset = m_aset_baru.id_aset) ";
        }
        // $select_column .= "";
    ...
    function make_datatables_lap($searcMap)
    {
    ...
    function get_filtered_data_lap($searcMap)
    {
        // $id = $id;
        $searcMap = $searcMap;
    ...
    function get_all_data_lap($searcMap)
    {
        $searcMap = $searcMap;
    ...
    FROM
        `m_aset_baru`
        LEFT JOIN (SELECT * FROM m_aset_det GROUP BY  id_aset";
        if ($searcMap == "3") {
            $select_column .= " HAVING status_map = 3 ";
        } else if ($searcMap == "2") {

            $select_column .= " HAVING status_map = 2 ";
        } else if ($searcMap == "1") {

            $select_column .= " HAVING status_map = 1 ";
        } else {
        }
        $select_column .= "ORDER BY status_map asc ) m_aset_det ON (
                m_aset_det.id_aset = m_aset_baru.id_aset)";
        ...
        if ($searcMap != "") {
            $this->db->where('m_aset_det.status_map', $searcMap);
        }
        foreach ($column_search as $item) // loop column 
        {
            if (@$_POST['search']['value']) // if datatable send POST for search
    ...
    function make_datatables_export($searcMap)
    {
