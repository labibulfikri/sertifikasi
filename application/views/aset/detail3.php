        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group row">
                    <div class="col">
                        <!-- data-idpeta="<?= $id_set_peta ?>"  -->

                        <!--   -->
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal_peta" data-id="<?= $id_aset ?>" id="tombol_peta" data-toggle="modal" data-reg="<?= $noreg ?>"> Tambah Data </button>
                        <hr />
                            ...
                            <table class="display expandable-table petas" style="width:100%">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 10%">Tanggal SPS </th>
                                        <th style="width: 10%">No. NIB</th>
                                        <th style="width: 10%">Tanggal NIB</th>
                                ...
                                <tbody>
                                    <?php foreach ($peta as $petanya) { ?>
                                        <tr>
                                            ...
                                            <!-- <td>  <?= $petanya->register_baru ?></td> -->
                                            <td> <?= $petanya->no_sps ?> </td>
                                            <td> <?= $petanya->tgl_sps ?> </td>
                                            <td> <?= $petanya->no_nib ?></td>
                                            <td> <?= $petanya->tgl_nib ?> </td>
                                            <td> <?= $petanya->luas_peta ?> m<sup>2</sup> </td>
                ...
                <!-- data-idpermohonan="<?= $id_set_permohonan ?>" -->

                <div class="form-group row">
                    <div class="col">
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal_permohonan" id="tombol_permohonan" data-idmohon="<?= $id_aset ?>" data-toggle="modal" data-mohonreg="<?= $noreg ?>"> Tambah Data </button>
                        <hr />
                        <div class="table-responsive">
                            <table class="display expandable-table mohon" style="width:100%">
                                ...
                                <thead>
                                    <tr>
                                        <th style="width: 10%">Nomor SPS </th>
                                        <th style="width: 10%">Tanggal SPS</th>
                                        <th style="width: 10%">Tanggal Penelitian </th>
                                        <th style="width: 10%">No SK BPN</th>
                                        <th style="width: 10%">Tanggal SK BPN</th>
                                        <th style="width: 10%">Status</th>
                                        <th style="width: 10%">Luas </th>
                                        <th style="width: 10%">Keterangan </th>
                                        <th style="width: 10%">Aksi </th>
                            ...
                            <table class="display expandable-table mohon" style="width:100%">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 10%">Tanggal Sertifikat</th>
                                        <th style="width: 10%">Status</th>
                                        <th style="width: 10%">Luas</th>
                                        <th style="width: 10%">Keterangan</th>
                                        <th style="width: 10%">Aksi </th>
                                ...
                                <tbody>
                                    <?php foreach ($pendaftaran_hak as $daftar) { ?>
                                        <tr>
                                            ...
                                            <td> <?= $daftar->no_sps_pendaftaran ?> </td>
                                            <td> <?= $daftar->tgl_sps_pendaftaran ?> </td>
                                            <td> <?= $daftar->no_sertifikat ?> </td>
                                            <td> <?= $daftar->tgl_sertifikat ?> </td>
                                            <td> <?= $daftar->status_pendaftaran ?> </td>
                                            <td> <?= $daftar->luas_pendaftaran ?> m<sup>2</sup> </td>
                                            <td> <?= $daftar->keterangan_pendaftaran ?> </td>
                                            <td>
                                                <button data-bs-target="#edit_modal_pendaftaran" data-tglsertifikat="<?= $daftar->tgl_sertifikat ?>" data-nosertifikat="<?= $daftar->no_sertifikat ?>" data-iddaftar="<?= $daftar->id_det_aset ?>" data-daftarreg="<?= $daftar->register_baru ?>" data-daftarketerangan="<?= $daftar->keterangan_pendaftaran ?>" data-idasetdaftar="<?= $id_aset ?>" data-nospsdaftar="<?= $daftar->no_sps_pendaftaran ?>" data-biayapendaftaran="<?= $daftar->biaya_pendaftaran ?>" data-luaspendaftaran="<?= $daftar->luas_pendaftaran ?>" data-statuspendaftaran="<?= $daftar->status_pendaftaran ?>" data-tglspspendaftaran="<?= $daftar->tgl_sps_pendaftaran ?>" id="tombol_edit_daftar" class="btn btn-warning btn-sm" data-bs-toggle="modal"> Update
                                                </button>
                ...
                <div class="form-group row">
                    <div class="col">
                        ...
                        <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#modal_sertifikat" data-id_aset_sertifikat="<?= $id_aset ?>" id="tombol_sertifikasi" data-toggle="modal" data-reg="<?= $noreg ?>"> Tambah Data </button>
                        <hr />
                        <div class="table-responsive">
...
<script>
    ...
    $(document).on('click', '#tombol_sertifikasi', function() {
        var id_aset = $(this).data("id_aset_sertifikat");
