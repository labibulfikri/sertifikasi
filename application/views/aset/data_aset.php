             ...
             <!-- <div class="row">
                 ...
                 <div class="col-md-3 stretch-card transparent">
                     <div class="card card-light-danger">
                         <div class="card-body">
                             <h3 class="mb-3"> Kategori A dan B</h3>
...
// form.append("offset", "20");

// var settings = {
//   "url": "https://api.surabaya.go.id/integrasi/api/data_persil/",
//   "method": "POST",
//   "timeout": 0,
//   "headers": {
//     "user": "data_persil",
